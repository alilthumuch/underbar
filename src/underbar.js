(function() {
  ...
  _.uniq = function(array, isSorted, iterator) {
    ...
    for (var x = 0; x < array.length; x ++)
    {
      ...
      else if (!isUnique.includes(iterator(array[x])))
      {
        newArr.push(array[x]);
        isUnique.push(iterator(array[x]));
      };
    };
    return newArr;
  };
  ...
  _.map = function(collection, iterator) {
    ...
    for (var x = 0; x < collection.length; x++)
    {
      newArr.push(iterator(collection[x]));
    }
    return newArr;
  };
  ...
  _.some = function(collection, iterator) {
    ...
    for (var x = 0; x < collection.length; x++)
    {
      if (iterator === undefined) //check if iterator is undefined
      {
        if(Boolean(collection[x]) === true)
        {
          acc = true;
        }
      }
      else if (Boolean(iterator(collection[x])) === true) //if any value is true, set acc to true
      {
        acc = true;
      }
    }
